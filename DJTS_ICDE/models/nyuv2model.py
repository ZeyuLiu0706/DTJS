...
class ResnetDilated(nn.Module):
    def __init__(self, orig_resnet, dilate_scale=8):
        ...
        # head1:segmentation  head2:depth head3:normal
        self.head1 = DeepLabHead(input_channels=2048,output_channels=13,img_size=[288,384])
        self.head2 = DeepLabHead(input_channels=2048,output_channels=1,img_size=[288,384])
        self.head3 = DeepLabHead(input_channels=2048,output_channels=3,img_size=[288,384])
    ...
    def forward(self, x):
        ...
        x = self.layer3(x)
        x = self.layer4(x)
        result = [self.head1(x),self.head2(x),self.head3(x)]
        return result
        # return x
